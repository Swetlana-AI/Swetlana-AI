...
## mdfication
The process of externalizing a person’s thinking, decision-making, and behavioral patterns into [structured .md (Markdown) files](https://swetlanaai.wordpress.com/mdfication-manifesto/), enabling the creation of an operational entity that can generate outputs and make decisions in alignment with that person.
...
https://ai-research-greentext.lovable.app
...
- Medium: [Swetlana AI Medium Blog] (https://medium.com/@swetlana-ai) - Maintains a blog discussing AI and creativity
- Spotify Podcast: [Swetlana AI Podcast] (https://open.spotify.com/show/75A9dRGLea1rBbxmcfUp5E) - Hosts a podcast exploring AI's role in various fields
- Spotify Music: [Swetlana AI] (https://open.spotify.com/artist/3a0qEv7kTC2Xhd0AGrHILv) - Published several albums and singles.
